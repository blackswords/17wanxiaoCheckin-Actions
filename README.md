# 原作者跑路了23333
# 项目目前存在一个问题，就是完美校园新增设备检测，导致登录时会要求手机验证码登录。
# 我的一个解决想法是，模拟机型，通过营造虚拟的设备环境，从而应付检测
# 可行的手段，应该是修改登录请求时发送的信息中关于设备机型的信息。
# 可以通过监测真机发送的信息抓包分析，找到信息所在的地方。
# 理论上并不会多难，因为完美校园的项目结构并不安全。
# 待我做完课设试试吧
